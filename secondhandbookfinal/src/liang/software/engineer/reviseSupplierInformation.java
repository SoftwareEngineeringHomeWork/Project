...
public class reviseSupplierInformation extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setViews();
		setListeners();
		Cursor cursor = sDatabase.rawQuery("select comname,pername," +
				"addr,city,diqu,youbian,tel,chuangzhen,web from gongys", null);
		cursor.moveToFirst();
		String cname = null;
		String pname = null;
		String padd = null;
	...
	private void setListeners() {
		bt1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (et1.getText().toString().equals("")) {
					Dialog.builder(reviseSupplierInformation.this, "提示", "请输入卖家名称");
				} else {
					// 查询语句
					...
					String selectStr = "select comname,pername,addr,city," +
							"diqu,youbian,tel,chuangzhen,web from gongys";
					...
					Toast.makeText(reviseSupplierInformation.this, "修改成功", Toast.LENGTH_LONG).show();
		...
		bt2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(reviseSupplierInformation.this, Menu.class);
