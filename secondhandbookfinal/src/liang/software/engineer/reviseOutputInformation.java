...
public class reviseOutputInformation extends Activity {
	sqlOpenHelper book;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		date.init(year , mon ,day 
				, new OnDateChangedListener()
			{
				...
				public void onDateChanged(DatePicker arg0, int year
					, int month, int day)
				{
					reviseOutputInformation.this.year = year;
					reviseOutputInformation.this.mon = month;
					reviseOutputInformation.this.day = day;
					//显示当前日期、时间
		...
		BaseAdapter ba = new BaseAdapter() {
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				TextView text = new TextView(reviseOutputInformation.this);
	...
	private void setListeners() {
		bt1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if(et5.getText().toString().equals("")||et6.getText().toString().equals("")){
					Dialog.builder(reviseOutputInformation.this, "提示", "请填写完整信息");
					...
					String espgs=et6.getText().toString().trim();	
						...
						// 定义ID
						Cursor seCursor = sDatabase.rawQuery("select max(_id) from chuku", null);
						try {
						...
						Toast.makeText(reviseOutputInformation.this, "修改成功", Toast.LENGTH_LONG).show();
		...
		bt2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(reviseOutputInformation.this, Menu.class);
