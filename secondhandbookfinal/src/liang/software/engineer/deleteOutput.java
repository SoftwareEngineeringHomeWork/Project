...
public class deleteOutput extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.deleteioput);
		setTitle("删除出售");
					...
					if(arg2==i){
						...
						builder.setPositiveButton("确定", new OnClickListener() {
							...
							public void onClick(DialogInterface dialog, int which) {
								...
								sDatabase.execSQL("delete from chuku where _id='"+id[j]+"'");
								Intent intent=new Intent();
								intent.setClass(deleteOutput.this, deleteOutput.class);
