...
public class inquiryInput extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.inquiryioput);
		setTitle("查询收购");
		...
		Cursor cursor = sDatabase.rawQuery("select _id,comname,pername,tel,products,guige,danwei,danjia,num,date  from ruku", null);
		cursor.moveToFirst();
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				for(int i=0;i<cname.length;i++){
					...
					sDatabase.execSQL("delete from ruku where comname='"+cname[j]+"'");
								Intent intent=new Intent();
								intent.setClass(inquiryInput.this, inquiryInput.class);
