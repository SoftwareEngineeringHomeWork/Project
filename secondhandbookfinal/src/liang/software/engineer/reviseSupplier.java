...
public class reviseSupplier extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Cursor cursor = sDatabase.rawQuery("select _id,comname,pername,addr,city,diqu,youbian,tel,chuangzhen,web  from gongys", null);
					...
					if(arg2==i){
						...
						builder.setPositiveButton("确定", new OnClickListener() {
							...
							public void onClick(DialogInterface dialog, int which) {
								...
								intent.setClass(reviseSupplier.this, reviseSupplierInformation.class);
